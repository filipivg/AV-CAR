...
public class AddPagamento extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Adicionar Pagamento");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AddPagamento.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AddPagamento().setVisible(true);
            }
        });
    }
